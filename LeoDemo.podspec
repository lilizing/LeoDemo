...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lilizing/LeoDemo"
  ...
  s.source       = { :git => "https://github.com/lilizing/LeoDemo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LeoDemo/LeoDemo/**/*.{h,m,swift}"
